...
class BasePage:
    ...
    def _find_element(self,loc,timeout=10,poll_frequency=0.5):
        return WebDriverWait(self._driver,timeout,poll_frequency).until(EC.visibility_of_element_located(loc))
    ...
    def _find_elements(self,loc,timeout=10,poll_frequency=0.5):
        ...
        return WebDriverWait(self._driver,timeout,poll_frequency).until(EC.visibility_of_all_elements_located(loc))
